    ...
    class DragSelector {
        ...
        #injectStyles() {
            ...
            style.textContent = `
                ...
                @keyframes DS-Indicator-PopIn { 0% { opacity: 0; transform: translate(-50%, -20px) scale(0.8); } 80% { opacity: 1; transform: translate(-50%, -65px) scale(1.05); } 100% { opacity: 1; transform: translate(-50%, -60px) scale(1); } }
